...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '') {
        ...
        $stmt = $pdo->prepare("UPDATE products SET name=:name, price=:price, stok=:stok WHERE id=:id");
        $stmt->execute([':name' => $name, ':price' => $price, ':stok' => $stok, ':id' => $id]);
...
<head>
    ...
    <meta name="description" content="Edit detail produk yang sudah ada di sistem TokoKu.">
...
<div class="main-container">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Perbarui informasi produk: <strong><?= htmlspecialchars($product['name']) ?></strong></p>
        </div>
